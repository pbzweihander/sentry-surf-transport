// https://github.com/getsentry/sentry-rust/blob/0.23.0/sentry/src/transports/surf.rs

use std::time::Duration;

use sentry::{ClientOptions, Envelope, Transport};
use surf::{http::headers as SurfHeaders, Client as SurfClient};

use crate::thread::TransportThread;
